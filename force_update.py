import django
import os
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'backend.settings') # Change backend.settings to actual settings module if different
...
print(f"Bypassed validation and updated IDs for {count} participants.")
